...
export const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    topBannerClasses: "Classes 1 to 12 (CBSE • WBBPE / WBBSE / WBCHSE + JEE / WBJEE)",
    topBannerHelpline: "WhatsApp: 9732531730 (WhatsApp Only)",
    ...
    heroSubtitle: "Biley Academy delivers structured, concept-first coaching across English, Mathematics, Science, Biology, Physics, Chemistry, and Computer Science / Application in Jamna, Pingla. Offline foundations for primary grades and Hybrid JEE & Board orientation for secondary & higher secondary.",
    ...
    officialBannerSubheading: "Classes 1 to 12 • Comprehensive Subject Coverage • CBSE • WBBPE, WBBSE & WBCHSE",
    ...
    officialBannerFeature3: "Dedicated Foundation for Olympiads, JEE (Main + Adv) & WBJEE",
    ...
    curriculumSubtitle: "Carefully designed academic syllabi combining school board excellence (CBSE / WBBPE / WBBSE / WBCHSE) with entrance exam readiness (JEE, WBJEE, Olympiads).",
    ...
    primaryGradeDesc: "Foundational Literacy, Numeracy, Environmental Discovery (WBBPE / CBSE), Coding Logic & Creative Expression.",
    upperPrimaryGradeDesc: "Bridging concrete ideas to abstract concepts in Mathematics, Physics, Chemistry, Biology & Computer Science (WBBSE / CBSE).",
    secondaryGradeDesc: "Board exam excellence (WBBSE Madhyamik & CBSE Class 9-10) with foundation for Olympiads, NTSE, and competitive engineering tracks.",
    higherSecondaryGradeDesc: "Specialized streams in Pure Science, Mathematics, Computer Science & AI (WBCHSE / CBSE), targeting Board Toppers + JEE / WBJEE.",
    ...
    admissionTargetGoal: "Target Academic Goal (Boards / JEE / WBJEE / Olympiad)",
    ...
    contactPhoneLabel: "WhatsApp Contact (WhatsApp Only)",
  ...
  bn: {
    ...
    topBannerClasses: "ক্লাস ১ থেকে ১২ (CBSE • WBBPE / WBBSE / WBCHSE + JEE / WBJEE)",
    topBannerHelpline: "হোয়াটসঅ্যাপ: ৯৭৩২৫৩১৭৩০ (শুধুমাত্র হোয়াটসঅ্যাপ)",
    ...
    heroSubtitle: "বিলে অ্যাকাডেমি (Biley Academy) জামনা, পিংলায় ইংরেজি, গণিত, বিজ্ঞান, জীবন বিজ্ঞান, পদার্থবিদ্যা, রসায়ন এবং কম্পিউটার সায়েন্স ও অ্যাপ্লিকেশনের সুসংগঠিত কনসেপ্ট-ফার্স্ট কোচিং প্রদান করে। প্রাথমিক শ্রেণির জন্য অফলাইন ভিত্তি এবং মাধ্যমিক ও উচ্চ মাধ্যমিকের জন্য বোর্ড ও JEE ওরিয়েন্টেশন।",
    ...
    officialBannerSubheading: "ক্লাস ১ থেকে ১২ • সম্পূর্ণ বিষয়ভিত্তিক পাঠদান • CBSE • WBBPE, WBBSE ও WBCHSE",
    ...
    officialBannerFeature3: "অলিম্পিয়াড, JEE (মেইন + অ্যাডভান্সড) এবং WBJEE-এর সুদৃঢ় ভিত্তি",
    ...
    curriculumSubtitle: "স্কুল বোর্ডের সিলেবাস (CBSE / WBBPE / WBBSE / WBCHSE) এবং সর্বভারতীয় প্রবেশিকা পরীক্ষার (JEE, WBJEE, Olympiad) ভারসাম্যপূর্ণ সমন্বয়।",
    ...
    primaryGradeDesc: "মৌলিক সাক্ষরতা, সংখ্যার জ্ঞান, পরিবেশ পর্যবেক্ষণ (WBBPE / CBSE), প্রাথমিক কোডিং লজিক ও সৃজনশীল বিকাশ।",
    upperPrimaryGradeDesc: "গণিত, পদার্থবিদ্যা, রসায়ন, জীবনবিজ্ঞান ও কম্পিউটার সায়েন্সের ধারণাগত উত্তরণ (WBBSE / CBSE)।",
    secondaryGradeDesc: "মাধ্যমিক বোর্ড পরীক্ষায় শীর্ষস্থান (WBBSE মাধ্যমিক ও CBSE) অর্জনের পাশাপাশি অলিম্পিয়াড ও প্রবেশিকা পরীক্ষার ভিত্তি নির্মাণ।",
    higherSecondaryGradeDesc: "বিশুদ্ধ বিজ্ঞান, গণিত, কম্পিউটার সায়েন্স ও এআই স্পেশালাইজেশন (WBCHSE / CBSE) — বোর্ড টপার ও JEE / WBJEE প্রস্তুতি।",
    ...
    admissionTargetGoal: "প্রধান লক্ষ্য (বোর্ড পরীক্ষা / JEE / WBJEE / অলিম্পিয়াড)",
